...
image_clock = pygame.image.load("/Users/adilkhan/Documents/work/Practice9/mickeys_clock/images/clock.png").convert_alpha()
image_clock = pygame.transform.scale(image_clock, (750, 600))

mickey = pygame.image.load("/Users/adilkhan/Documents/work/Practice9/mickeys_clock/images/mickey.png").convert_alpha()
mickey = pygame.transform.scale(mickey, (400, 280))

hand_left = pygame.image.load("/Users/adilkhan/Documents/work/Practice9/mickeys_clock/images/left_hand.png").convert_alpha()
hand_left = pygame.transform.scale(hand_left, (150, 190))

hand_right = pygame.image.load("/Users/adilkhan/Documents/work/Practice9/mickeys_clock/images/right_hand.png").convert_alpha()
...
def draw_hand(image, angle, pivot_pos):
    ...
    rotated_rect = rotated_image.get_rect(center=pivot_pos )
